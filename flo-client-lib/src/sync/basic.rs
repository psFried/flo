...
pub fn connect_with_binary_codec<T: ToSocketAddrs>(address: T) -> io::Result<Connection<RawCodec>> {
...
pub fn connect_with_string_codec<T: ToSocketAddrs>(address: T) -> io::Result<Connection<StringCodec>> {
